...
export function AdminApp() {
    return (_jsx(AuthProvider, { children: _jsx(BrowserRouter, { children: _jsxs(Routes, { children: [_jsx(Route, { path: "/login", element: _jsx(LoginPage, {}) }), _jsx(Route, { path: "/access-denied", element: _jsx(AccessDeniedPage, {}) }), _jsx(Route, { element: _jsx(AuthGuard, {}), children: _jsxs(Route, { element: _jsx(AdminProvider, { children: _jsx(AdminShell, {}) }), children: [_jsx(Route, { path: "/", element: _jsx(DashboardPage, {}) }), _jsx(Route, { path: "/site/overview", element: _jsx(SiteOverviewPage, {}) }), _jsx(Route, { path: "/site/markets-locales", element: _jsx(MarketsLocalesPage, {}) }), _jsx(Route, { path: "/site/content-types", element: _jsx(ContentTypesPage, {}) }), _jsx(Route, { path: "/site", element: _jsx(Navigate, { to: "/site/overview", replace: true }) }), _jsx(Route, { path: "/content/pages/:contentItemId", element: _jsx(ContentPagesPage, {}) }), _jsx(Route, { path: "/content/pages", element: _jsx(ContentPagesPage, {}) }), _jsx(Route, { path: "/content/templates", element: _jsx(TemplatesPage, {}) }), _jsx(Route, { path: "/content/routes", element: _jsx(RoutesPage, {}) }), _jsx(Route, { path: "/content/assets", element: _jsx(AssetLibraryPage, {}) }), _jsx(Route, { path: "/content", element: _jsx(Navigate, { to: "/content/pages", replace: true }) }), _jsx(Route, { path: "/schema/content-types", element: _jsx(Navigate, { to: "/site/content-types", replace: true }) }), _jsx(Route, { path: "/schema", element: _jsx(Navigate, { to: "/site/content-types", replace: true }) }), _jsx(Route, { path: "/settings/global/connectors/auth", element: _jsx(AuthConnectorsPage, {}) }), _jsx(Route, { path: "/settings/global/connectors/db", element: _jsx(DbConnectorsPage, {}) }), _jsx(Route, { path: "/settings/global/connectors/dam", element: _jsx(DamConnectorsPage, {}) }), _jsx(Route, { path: "/settings/global/connectors/ai", element: _jsx(AiConnectorsPage, {}) }), _jsx(Route, { path: "/personalization/variants", element: _jsx(VariantsPage, {}) }), _jsx(Route, { path: "/personalization", element: _jsx(Navigate, { to: "/personalization/variants", replace: true }) }), _jsx(Route, { path: "/forms/builder/:formId", element: _jsx(FormBuilderPage, {}) }), _jsx(Route, { path: "/forms/builder", element: _jsx(FormBuilderPage, {}) }), _jsx(Route, { path: "/forms", element: _jsx(Navigate, { to: "/forms/builder", replace: true }) }), _jsx(Route, { path: "/workflows/designer", element: _jsx(WorkflowDesignerPage, {}) }), _jsx(Route, { path: "/workflows/runs", element: _jsx(WorkflowRunsPage, {}) }), _jsx(Route, { path: "/workflows", element: _jsx(Navigate, { to: "/workflows/designer", replace: true }) }), _jsx(Route, { path: "/security/users", element: _jsx(UsersPage, {}) }), _jsx(Route, { path: "/security/roles", element: _jsx(RolesPage, {}) }), _jsx(Route, { path: "/security", element: _jsx(Navigate, { to: "/security/users", replace: true }) }), _jsxs(Route, { element: _jsx(DevGuard, {}), children: [_jsx(Route, { path: "/dev/graphiql", element: _jsx(GraphiQLPage, {}) }), _jsx(Route, { path: "/dev/diagnostics", element: _jsx(DiagnosticsPage, {}) })] }), _jsx(Route, { path: "*", element: _jsx(NotFoundPage, {}) })] }) }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/", replace: true }) })] }) }) }));
}
